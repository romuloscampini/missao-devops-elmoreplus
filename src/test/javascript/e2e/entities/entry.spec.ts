...
describe('Entry e2e test', () => {
    ...
    it('should load create Entry dialog', () => {
        ...
        expect(entryDialogPage.getModalTitle())
            .toMatch(/Create or edit a Entry/);
    ...
    it('should create and save Entries', () => {
        ...
        entryDialogPage.pageSelectLastOption();
...
export class EntryDialogPage {
    ...
    pageSelect = element(by.css('select#field_page'));
    ...
    pageSelectLastOption = function() {
        this.pageSelect.all(by.tagName('option')).last().click();
    };

    pageSelectOption = function(option) {
        this.pageSelect.sendKeys(option);
    };
    ...
    getPageSelectedOption = function() {
